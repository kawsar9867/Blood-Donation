  ...
  return (
    <div className="card">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border)', paddingBottom: '1.25rem', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <h2 style={{ fontSize: '1.5rem', color: 'var(--secondary)' }}>My Donation Requests</h2>
          <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>Browse, track and manage all the blood donation requests you've created.</p>
        </div>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', padding: '4rem 0' }}>
          ...
          <p style={{ color: 'var(--text-muted)' }}>You haven't created any blood donation requests matching the filter criteria.</p>
        </div>
      )}
