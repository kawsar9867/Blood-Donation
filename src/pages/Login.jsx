...
export default function Login() {
  ...
  const demoAccounts = {
    client: {
      email: "client@lifeblood.org",
      password: "password123",
      label: "Client (Donor)",
    },
    doctor: {
      email: "doctor@lifeblood.org",
      password: "password123",
      label: "Doctor (Volunteer)",
    },
    admin: {
      email: "kawsarbosuniya52@gmail.com",
      password: "kawsar123",
      label: "Admin",
    },
  };
          ...
          >
            <button
              ...
              style={{
                ...
                gap: "0.25rem",
                borderColor:
                  selectedRole === "client" ? "var(--primary)" : (
                    "var(--border)"
                  ),
              }}
            ...
            <button
              ...
              style={{
                ...
                gap: "0.25rem",
                borderColor:
                  selectedRole === "doctor" ? "var(--primary)" : (
                    "var(--border)"
                  ),
              }}
            ...
            <button
              ...
              style={{
                ...
                gap: "0.25rem",
                borderColor:
                  selectedRole === "admin" ? "var(--primary)" : "var(--border)",
              }}
